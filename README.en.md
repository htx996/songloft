...
- 🔒 **Privacy** — No user data is ever collected. Official builds report only anonymous operational stats (version, crash traces); self-compiled builds have zero telemetry. See [PRIVACY.md](./PRIVACY.md) for details
