...
- [AGENTS.md](https://github.com/songloft-org/songloft/blob/main/AGENTS.md) -- 项目入口信息：常用命令、数据库规范、编码约定、API 文档规范、Git 约定、构建部署
- [Makefile](https://github.com/songloft-org/songloft/blob/main/Makefile) -- 构建、测试、代码生成、Docker 等全部 Make 目标
- [Dockerfile](https://github.com/songloft-org/songloft/blob/main/Dockerfile) -- 多阶段 Docker 构建流程与运行时环境
- [sqlc.yaml](https://github.com/songloft-org/songloft/blob/main/sqlc.yaml) -- sqlc 代码生成配置（引擎、输入输出路径、生成选项）
- [go.mod](https://github.com/songloft-org/songloft/blob/main/go.mod) -- Go 模块声明、版本要求与依赖列表
...
前端代码位于 `clients/player/`（独立仓库），开发时需先 clone 或初始化子模块。
...
**章节来源**
- [go.mod:1-3](https://github.com/songloft-org/songloft/blob/main/go.mod#L1-L3) -- 模块名与 Go 版本要求
- [Makefile:3-4](https://github.com/songloft-org/songloft/blob/main/Makefile#L3-L4) -- `CGO_ENABLED=0` 与 `GO_VERSION`
- [Dockerfile:59-69](https://github.com/songloft-org/songloft/blob/main/Dockerfile#L59-L69) -- 运行时镜像依赖
...
前端构建产物统一输出到 `clients/player-build/`（不是 `clients/player/build/`）。
...
- [Makefile:57-95](https://github.com/songloft-org/songloft/blob/main/Makefile#L57-L95) -- 前端构建目标
- [AGENTS.md:30-49](https://github.com/songloft-org/songloft/blob/main/AGENTS.md#L30-L49) -- 常用命令速查表
...
**章节来源**
- [AGENTS.md:70-77](https://github.com/songloft-org/songloft/blob/main/AGENTS.md#L70-L77) -- 后端编码约定
- [go.mod:6-10](https://github.com/songloft-org/songloft/blob/main/go.mod#L6-L10) -- 核心依赖（squirrel、chi、jwt）
...
**章节来源**
- [AGENTS.md:54-66](https://github.com/songloft-org/songloft/blob/main/AGENTS.md#L54-L66) -- 数据库规范（铁律）
- [sqlc.yaml:1-17](https://github.com/songloft-org/songloft/blob/main/sqlc.yaml#L1-L17) -- sqlc 完整配置
- [go.mod:6](https://github.com/songloft-org/songloft/blob/main/go.mod#L6) -- squirrel 依赖；[go.mod:14](https://github.com/songloft-org/songloft/blob/main/go.mod#L14) -- goose 依赖
...
**章节来源**
- [AGENTS.md:82-123](https://github.com/songloft-org/songloft/blob/main/AGENTS.md#L82-L123) -- API 文档规范（铁律）
- [Makefile:329-337](https://github.com/songloft-org/songloft/blob/main/Makefile#L329-L337) -- `make swagger` 目标
...
**章节来源**
- [AGENTS.md:65-66](https://github.com/songloft-org/songloft/blob/main/AGENTS.md#L65-L66) -- 测试规范
- [Makefile:206-234](https://github.com/songloft-org/songloft/blob/main/Makefile#L206-L234) -- 测试 Make 目标
...
多阶段构建：`ghcr.io/songloft-org/songloft-base-golang:1.26-alpine`（编译阶段，BuildKit 缓存挂载加速） → `ghcr.io/songloft-org/songloft-base-alpine:3.24`（运行时，含 ffmpeg、ALSA、ca-certificates）。发布工作流会先将 Docker Hub 上游基础镜像同步到 GHCR，再执行多平台构建。
...
完整版构建时前端产物必须位于 `clients/player-build/web-embedded/`（不是 `clients/player/build/`），由 `internal/app/embed.go` 嵌入。

**章节来源**
- [AGENTS.md:178-185](https://github.com/songloft-org/songloft/blob/main/AGENTS.md#L178-L185) -- 构建标签与矩阵
- [Makefile:1-4](https://github.com/songloft-org/songloft/blob/main/Makefile#L1-L4) -- `CGO_ENABLED=0`
- [Makefile:19-26](https://github.com/songloft-org/songloft/blob/main/Makefile#L19-L26) -- LDFLAGS 注入
- [Dockerfile:1-57](https://github.com/songloft-org/songloft/blob/main/Dockerfile#L1-L57) -- 多阶段构建流程
...
**章节来源**
- [AGENTS.md:169-173](https://github.com/songloft-org/songloft/blob/main/AGENTS.md#L169-L173) -- Git 提交约定
- [Makefile:339-341](https://github.com/songloft-org/songloft/blob/main/Makefile#L339-L341) -- `make bump` 目标
