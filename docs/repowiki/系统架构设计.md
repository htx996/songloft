...
- [internal/app/app.go](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go) -- 应用主结构与 Init 启动链
- [internal/app/routers.go](https://github.com/songloft-org/songloft/blob/main/internal/app/routers.go) -- 路由注册与中间件栈
- [internal/app/source_adapters.go](https://github.com/songloft-org/songloft/blob/main/internal/app/source_adapters.go) -- adapter pattern 实现
- [internal/app/embed.go](https://github.com/songloft-org/songloft/blob/main/internal/app/embed.go) -- SPA 静态文件服务与预压缩
- [internal/app/compress.go](https://github.com/songloft-org/songloft/blob/main/internal/app/compress.go) -- Brotli/Gzip 预压缩文件系统
- [internal/app/access_log.go](https://github.com/songloft-org/songloft/blob/main/internal/app/access_log.go) -- slog 访问日志桥接
- [internal/app/db_migration.go](https://github.com/songloft-org/songloft/blob/main/internal/app/db_migration.go) -- 旧版数据库迁移
- [internal/app/router_dev.go](https://github.com/songloft-org/songloft/blob/main/internal/app/router_dev.go) -- dev 构建条件编译（Swagger）
- [internal/app/router_prod.go](https://github.com/songloft-org/songloft/blob/main/internal/app/router_prod.go) -- prod 构建空实现
- [internal/app/pprof_dev.go](https://github.com/songloft-org/songloft/blob/main/internal/app/pprof_dev.go) -- dev 构建 pprof 服务
- [internal/database/database.go](https://github.com/songloft-org/songloft/blob/main/internal/database/database.go) -- DB 接口定义
- [internal/database/sqlite.go](https://github.com/songloft-org/songloft/blob/main/internal/database/sqlite.go) -- SQLite 实现与 goose 迁移
...
- [internal/services/source/fetcher.go](https://github.com/songloft-org/songloft/blob/main/internal/services/source/fetcher.go) -- 音源获取器接口
- [internal/services/source/resolver.go](https://github.com/songloft-org/songloft/blob/main/internal/services/source/resolver.go) -- 跨插件音源解析器
- [internal/services/source/orchestrator.go](https://github.com/songloft-org/songloft/blob/main/internal/services/source/orchestrator.go) -- 音源编排器
- [web_embed.go](https://github.com/songloft-org/songloft/blob/main/web_embed.go) -- 完整版前端嵌入
- [web_embed_lite.go](https://github.com/songloft-org/songloft/blob/main/web_embed_lite.go) -- 精简版空嵌入
- [Makefile](https://github.com/songloft-org/songloft/blob/main/Makefile) -- 构建系统
...
| `web_embed.go` | `//go:build !lite` | `//go:embed all:clients/player-build/web-embedded` |
