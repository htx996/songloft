...
- [clients/player/pubspec.yaml](https://github.com/songloft-org/clients/player/blob/main/pubspec.yaml) -- 依赖列表与项目配置
- [clients/player/lib/main.dart](https://github.com/songloft-org/clients/player/blob/main/lib/main.dart) -- 应用入口与初始化流程
- [clients/player/lib/config/app_config.dart](https://github.com/songloft-org/clients/player/blob/main/lib/config/app_config.dart) -- 部署模式与编译时常量
- [clients/player/lib/core/router/app_router.dart](https://github.com/songloft-org/clients/player/blob/main/lib/core/router/app_router.dart) -- GoRouter 路由定义
- [clients/player/lib/core/audio/audio_service.dart](https://github.com/songloft-org/clients/player/blob/main/lib/core/audio/audio_service.dart) -- 音频服务封装
- [clients/player/lib/core/network/api_client.dart](https://github.com/songloft-org/clients/player/blob/main/lib/core/network/api_client.dart) -- Dio 网络层
- [clients/player/lib/core/network/auth_interceptor.dart](https://github.com/songloft-org/clients/player/blob/main/lib/core/network/auth_interceptor.dart) -- 认证拦截器
- [clients/player/lib/core/network/base_url_provider.dart](https://github.com/songloft-org/clients/player/blob/main/lib/core/network/base_url_provider.dart) -- BaseURL 状态管理
- [clients/player/lib/core/network/server_probe.dart](https://github.com/songloft-org/clients/player/blob/main/lib/core/network/server_probe.dart) -- 服务器可达性探测
- [clients/player/lib/core/theme/app_theme.dart](https://github.com/songloft-org/clients/player/blob/main/lib/core/theme/app_theme.dart) -- Material 3 主题构建
- [clients/player/lib/core/theme/responsive.dart](https://github.com/songloft-org/clients/player/blob/main/lib/core/theme/responsive.dart) -- 响应式断点与屏幕类型
- [clients/player/lib/core/storage/secure_storage.dart](https://github.com/songloft-org/clients/player/blob/main/lib/core/storage/secure_storage.dart) -- Token 存储
- [clients/player/lib/core/utils/url_helper.dart](https://github.com/songloft-org/clients/player/blob/main/lib/core/utils/url_helper.dart) -- 资源 URL 拼接
- [clients/player/lib/core/utils/platform_utils.dart](https://github.com/songloft-org/clients/player/blob/main/lib/core/utils/platform_utils.dart) -- 平台检测工具
- [clients/player/lib/core/utils/audio_format_helper.dart](https://github.com/songloft-org/clients/player/blob/main/lib/core/utils/audio_format_helper.dart) -- 音频格式转码判定
- [clients/player/lib/shared/layouts/shell_layout.dart](https://github.com/songloft-org/clients/player/blob/main/lib/shared/layouts/shell_layout.dart) -- ShellRoute 布局
- [clients/player/lib/shared/layouts/adaptive_scaffold.dart](https://github.com/songloft-org/clients/player/blob/main/lib/shared/layouts/adaptive_scaffold.dart) -- 自适应脚手架
- [clients/player/lib/features/startup/presentation/startup_gate.dart](https://github.com/songloft-org/clients/player/blob/main/lib/features/startup/presentation/startup_gate.dart) -- 启动门控
- [clients/player/lib/features/player/domain/player_state.dart](https://github.com/songloft-org/clients/player/blob/main/lib/features/player/domain/player_state.dart) -- 播放器状态模型
- [clients/player/lib/features/player/presentation/providers/player_provider.dart](https://github.com/songloft-org/clients/player/blob/main/lib/features/player/presentation/providers/player_provider.dart) -- 播放器 Notifier
- [clients/player/lib/features/auth/presentation/providers/auth_provider.dart](https://github.com/songloft-org/clients/player/blob/main/lib/features/auth/presentation/providers/auth_provider.dart) -- 认证状态管理
- [clients/player/lib/features/settings/presentation/providers/settings_provider.dart](https://github.com/songloft-org/clients/player/blob/main/lib/features/settings/presentation/providers/settings_provider.dart) -- 设置与主题
- [clients/player/lib/features/home/presentation/plugin_webview_page.dart](https://github.com/songloft-org/clients/player/blob/main/lib/features/home/presentation/plugin_webview_page.dart) -- 插件 WebView 条件导出
- [clients/player/lib/features/home/presentation/plugin_webview_page_native.dart](https://github.com/songloft-org/clients/player/blob/main/lib/features/home/presentation/plugin_webview_page_native.dart) -- 原生 WebView
- [clients/player/lib/features/home/presentation/plugin_webview_page_stub.dart](https://github.com/songloft-org/clients/player/blob/main/lib/features/home/presentation/plugin_webview_page_stub.dart) -- Web 平台桩
...
Songloft 前端是基于 Flutter 3.29+ / Dart 3.7+ 的跨平台音乐播放器，支持 Android、iOS、Web、macOS、Windows、Linux 六个平台。项目采用 feature-based 目录结构与 Riverpod 状态管理，通过 `just_audio` + `audio_service` 实现统一的音频播放体验，通过编译时常量控制 embedded/standalone 两种部署模式。
...
```mermaid
graph TB
    UI["UI 层\nMiniPlayer / DesktopPlayer"] --> PN["PlayerNotifier\n播放队列、模式、睡眠定时"]
...
| `desktop` | 900px+ | 左侧 240px 宽侧边栏 | `DesktopPlayer` |
...
**章节来源**: `lib/main.dart`、`lib/core/utils/platform_utils.dart`、`lib/core/utils/audio_format_helper.dart`、`lib/shared/layouts/adaptive_scaffold.dart`
