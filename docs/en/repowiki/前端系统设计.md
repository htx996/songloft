...
- `clients/player/pubspec.yaml` -- Dependency list and project configuration
- `clients/player/lib/main.dart` -- Application entry point and initialization flow
- `clients/player/lib/config/app_config.dart` -- Deployment mode and compile-time constants
- `clients/player/lib/core/router/app_router.dart` -- GoRouter route definitions
- `clients/player/lib/core/audio/audio_service.dart` -- Audio service wrapper
- `clients/player/lib/core/network/api_client.dart` -- Dio network layer
- `clients/player/lib/core/network/auth_interceptor.dart` -- Authentication interceptor
- `clients/player/lib/core/network/base_url_provider.dart` -- BaseURL state management
- `clients/player/lib/core/network/server_probe.dart` -- Server reachability probing
- `clients/player/lib/core/theme/app_theme.dart` -- Material 3 theme construction
- `clients/player/lib/core/theme/responsive.dart` -- Responsive breakpoints and screen types
- `clients/player/lib/core/storage/secure_storage.dart` -- Token storage
- `clients/player/lib/core/utils/url_helper.dart` -- Resource URL construction
- `clients/player/lib/core/utils/platform_utils.dart` -- Platform detection utilities
- `clients/player/lib/core/utils/audio_format_helper.dart` -- Audio format transcoding decision
- `clients/player/lib/shared/layouts/shell_layout.dart` -- ShellRoute layout
- `clients/player/lib/shared/layouts/adaptive_scaffold.dart` -- Adaptive scaffold
- `clients/player/lib/features/startup/presentation/startup_gate.dart` -- Startup gate
- `clients/player/lib/features/player/domain/player_state.dart` -- Player state model
- `clients/player/lib/features/player/presentation/providers/player_provider.dart` -- Player Notifier
- `clients/player/lib/features/auth/presentation/providers/auth_provider.dart` -- Authentication state management
- `clients/player/lib/features/settings/presentation/providers/settings_provider.dart` -- Settings and theme
- `clients/player/lib/features/home/presentation/plugin_webview_page.dart` -- Plugin WebView conditional export
- `clients/player/lib/features/home/presentation/plugin_webview_page_native.dart` -- Native WebView
- `clients/player/lib/features/home/presentation/plugin_webview_page_stub.dart` -- Web platform stub
...
The Songloft frontend is a cross-platform music player based on Flutter 3.29+ / Dart 3.7+, supporting six platforms -- Android, iOS, Web, macOS, Windows, and Linux. The project uses a feature-based directory structure and Riverpod state management, delivers a unified audio playback experience through `just_audio` + `audio_service`, and controls the embedded/standalone deployment modes through compile-time constants.
...
| `desktop` | 900px+ | Left 240px-wide sidebar | `DesktopPlayer` |
...
### 10.3 Windows Platform-Specific Handling
...
**Section sources**: `lib/main.dart`, `lib/core/utils/platform_utils.dart`, `lib/core/utils/audio_format_helper.dart`, `lib/shared/layouts/adaptive_scaffold.dart`
