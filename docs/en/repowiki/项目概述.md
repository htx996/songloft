...
- [main.go](https://github.com/songloft-org/songloft/blob/main/main.go) -- Program entry point, Swagger annotations, signal handling
- [internal/app/app.go](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go) -- Application initialization flow (`Init` / `Start` / `Close`)
- [internal/app/routers.go](https://github.com/songloft-org/songloft/blob/main/internal/app/routers.go) -- Route registration and middleware assembly
- [internal/config/types.go](https://github.com/songloft-org/songloft/blob/main/internal/config/types.go) -- Startup configuration structure definitions
- [internal/version/version.go](https://github.com/songloft-org/songloft/blob/main/internal/version/version.go) -- Version number injection and output
- [go.mod](https://github.com/songloft-org/songloft/blob/main/go.mod) -- Go module declaration and dependency list
- [Makefile](https://github.com/songloft-org/songloft/blob/main/Makefile) -- Build, test, and deployment commands
...
Songloft is a **self-hosted local music server** designed to let users manage and play local music and network audio sources in a unified way on their own hardware. The current version of the project is **2.10.0**; the source code is released as open source under the Apache 2.0 license (client binaries link GPL-3.0 WebF and are therefore distributed under GPL-3.0 — see the License section of the README).
...
**Section sources**
- [main.go:26-38](https://github.com/songloft-org/songloft/blob/main/main.go#L26-L38) -- Project description, version, and default port in the Swagger annotations
- [internal/version/version.go:1-24](https://github.com/songloft-org/songloft/blob/main/internal/version/version.go#L1-L24) -- Version number definitions
...
| `/clients/player` | Flutter 3.29+ / Dart 3.7+ | Cross-platform frontend (separate repository [songloft-player](https://github.com/songloft-org/songloft-player)) |
| `/plugins/toolchain` | TypeScript + pnpm | JS plugin development toolchain: SDK, Builder, scaffolding (separate repository) |
| `/plugins/src` | TypeScript | Collection of JS plugin sources (submodules; each plugin distributes releases from its own repository) |
| `/pkg/tag` | Go | Audio metadata read/write library (extends the upstream tag library with MP3/FLAC writing) |
| `/integrations/home-assistant` | HA add-on | Home Assistant add-on (thin layer reusing the Docker image; separate repository, mounted as a submodule) |
...
**Section sources**
- [go.mod:1-3](https://github.com/songloft-org/songloft/blob/main/go.mod#L1-L3) -- Module name and Go version
- [internal/app/app.go:34-58](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L34-L58) -- Overview of App struct fields (showing each core component)
...
**Section sources**
- [internal/app/app.go:87-391](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L87-L391) -- Creation and assembly of each service in the `Init()` method
- [internal/app/app.go:291-323](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L291-L323) -- Audio source processing chain assembly (Fetcher/Resolver/Orchestrator)
- [internal/app/app.go:378-389](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L378-L389) -- Asynchronous startup of automatic scanning and JS plugins
...
| Audio Playback | just_audio + just_audio_media_kit | Cross-platform audio backend (all native platforms use libmpv/media_kit) |
...
**Section sources**
- [go.mod:5-22](https://github.com/songloft-org/songloft/blob/main/go.mod#L5-L22) -- Direct dependency list
- [go.mod:57](https://github.com/songloft-org/songloft/blob/main/go.mod#L57) -- `pkg/tag` local replacement
...
**Diagram sources**
- [internal/app/app.go:34-58](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L34-L58) -- The App struct shows the composition relationships of each subsystem
- [internal/app/routers.go:1-35](https://github.com/songloft-org/songloft/blob/main/internal/app/routers.go#L1-L35) -- The route registration flow shows the assembly order of middleware and handlers
...
**Diagram sources**
- [main.go:45-78](https://github.com/songloft-org/songloft/blob/main/main.go#L45-L78) -- `main()` function: config parsing, initialization, signal handling, startup
- [internal/app/app.go:87-391](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L87-L391) -- Complete `Init()` initialization flow
...
**Section sources**
- [main.go:12-24](https://github.com/songloft-org/songloft/blob/main/main.go#L12-L24) -- Memory soft limit and GC configuration
- [internal/app/app.go:100-112](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L100-L112) -- Database opening and migration
...
**Section sources**
- [internal/app/app.go:547-637](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L547-L637) -- `ParseConfig()` function: CLI argument and environment variable parsing
- [internal/app/app.go:458-483](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L458-L483) -- `Start()` function: HTTP service startup and BasePath handling
- [Makefile:97-108](https://github.com/songloft-org/songloft/blob/main/Makefile#L97-L108) -- `build` / `build-lite` targets
- [Makefile:249-252](https://github.com/songloft-org/songloft/blob/main/Makefile#L249-L252) -- `run` target
- [Makefile:298-305](https://github.com/songloft-org/songloft/blob/main/Makefile#L298-L305) -- `docker-build` / `docker-run` targets
...
**Section sources**
- [main.go:26-28](https://github.com/songloft-org/songloft/blob/main/main.go#L26-L28) -- Project positioning description
- [internal/app/app.go:34-58](https://github.com/songloft-org/songloft/blob/main/internal/app/app.go#L34-L58) -- Overview of core components
