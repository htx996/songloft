    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "插件排序配置",
                        "schema": {
                            "$ref": "#/definitions/handlers.pluginOrderSetting"
                        }
                    }
                }
            },
        ...
        "/settings/tab-config": {
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "保存后的 Tab 配置（孤儿条目已清理）",
                        "schema": {
                            "$ref": "#/definitions/handlers.tabConfigSetting"
                        }
                    },
        ...
        "/song-tags": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "成功返回标签列表 {tags, total, limit, offset}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建参数 {name: string, color?: string}",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "201": {
                        "description": "创建成功",
                        "schema": {
                            "$ref": "#/definitions/models.SongTag"
                        }
                    },
                    "400": {
                        "description": "参数错误",
        ...
        "/song-tags/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "更新参数 {name?: string, color?: string}",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/song-tags/{id}/bind": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "歌曲 ID 列表 {song_ids: [1,2,3]}",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/song-tags/{id}/songs": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "成功返回 {songs, total, limit, offset}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/songs/facets": {
            "get": {
                ...
                "description": "按指定维度聚合曲库，返回该维度下非空取值、各自的歌曲数量及一首代表歌曲的封面 URL，用于「分类浏览」的卡片网格。\n支持维度：genre(流派)/artist(歌手)/album(专辑)/language(语种)/style(风格)/year(年份)/decade(年代)/tag(标签)。\nyear/decade 的 value 为数字字符串（年代如 \"1990\" 表示 1990-1999）。取到某取值后可用 /songs?\u003cfield\u003e=\u003cvalue\u003e 拉取该分类下歌曲（tag 维度除外——tag 的 value 为标签名，需用 /songs?tag_name=\u003cvalue\u003e 过滤）。\n支持 keyword 模糊搜索取值、limit/offset 分页、sort(count|name)/order 排序；返回 total 为该维度去重取值总数。",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/songs/folders": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "相对路径，空 = 音乐根目录",
                        "name": "path",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "搜索过滤（文件夹名 / 歌曲标题）",
                        "name": "keyword",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "成功 {path, parent_path, music_path, folders:[{name,path,song_count}], total_folders, songs:[...], total_songs}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/songs/{id}/song-tags": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "标签 ID 列表 {tag_ids: [1,2,3]}",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
